...
const TagNamePage = ({data, allTags, tagName} : TagNamePageProps) => {
    ...
    return (
        <>
            ...
            <section className='m-4 min-h-[50vh] max-w-6xl mx-auto flex flex-col-reverse md:flex-row gap-8 px-4'>
...
export const getStaticProps: GetStaticProps<TagNamePageProps> = async ({params}) => {
